    ...
    pub fn from_env() -> Result<Self> {
        let config = Self {
            ...
            use_kelly_sizing: env::var("USE_KELLY_SIZING")
                ...
                .parse()?,
            kelly_mode: env::var("KELLY_MODE").unwrap_or_else(|_| "conservative".to_string()),
            ...
            // APIs
            polygon_api_key: env::var("POLYGON_API_KEY").context("POLYGON_API_KEY not set")?,
